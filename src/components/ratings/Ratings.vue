<template lang="html">
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <v-split></v-split>
      <v-ratingselect @ratingtypeSelect="ratingtypeSelect" @contentToggle="contentToggle" :ratings="ratings" :selectType="selectType" :onlyContent="onlyContent"></v-ratingselect>
